        ...
        <footer className={"bg-[#222222] py-16 text-white"}>
            <div className={"grid grid-cols-1 lg:grid-cols-4 gap-10 xl:gap-16 max-w-7xl mx-auto text-sm px-10"}>
                ...
                <div className={"flex flex-col gap-3"}>
                    ...
                    <Link href={"/programas/programa-reproduccion-de-plantas-nativas-y-endemicas-amenazadas"} className={"hover:text-[#AFA96E] transition-colors"}>Reproduccion de plantas nativas y endemicas</Link>
                </div>
