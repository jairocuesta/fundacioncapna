    ...
    return (
        <div className={`h-screen w-full overflow-x-clip`}>
            ...
            <div className={"absolute flex flex-col items-center gap-5 w-full text-center left-1/2 -translate-x-1/2 bottom-20 text-white max-w-5xl"}>
                ...
                >
                    <span className={"sm:whitespace-nowrap z-10 relative"}>{`Todo lo que le damos a la Naturaleza,`}</span>
                    <span className={"sm:whitespace-nowrap z-10 relative"}>{`nos lo damos a nosotros`}</span>
                    <div className={"absolute w-full h-full bg-black opacity-40 blur-2xl"}></div>
                </motion.h2>
                <motion.span
                    animate={{ top: '30px' }}
