        ...
        <Layout title={"Conservación ambiental"}>
            <main>
                ...
                <div className={"flex flex-col gap-14 max-w-7xl mx-auto px-5 sm:px-10 lg:px-20 py-20"}>
                    ...
                    >
                        <Image loading={'eager'} src={"/home/programs/1.webp"} className={"w-full object-cover"} fill alt={"Conservación terrestre"} />
                    ...
                    <div
                        ...
                        style={{ aspectRatio: '16/7' }}
                    >
                        <Image loading={'eager'} src={"/home/programs/1.webp"} className={"w-full object-cover"} fill alt={"Conservación marina"} />
                        <div className={"absolute w-full h-full grid place-content-center"}>
