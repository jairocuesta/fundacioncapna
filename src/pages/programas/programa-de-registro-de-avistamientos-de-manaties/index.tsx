        ...
        <Layout title={"Programa de registro de avistamientos de manaties"}>
            <div className={"flex flex-col gap-16 pb-20 text-center sm:text-left"}>
                ...
                <div className={"relative -top-8 flex flex-col gap-4 max-w-7xl w-full px-5 sm:px-10 lg:px-20 mx-auto"}>
                    <Breadcrumb
                        routes={[
                            ...
                            { name: 'Registro de avistamientos de manaties', url: '/programas/programa-de-registro-de-avistamientos-de-manaties' },
                        ]}
                    />
                </div>
                ...
                <TextSlider
                    ...
                    images={[
                        {
                            src: "/programas/registro-de-avistamientos-de-manaties/1.webp"
                        },
                        {
                ...
                <HowCanHelp image={'/programas/registro-de-avistamientos-de-manaties/banner.webp'} />
                <div className={"flex flex-col gap-4 max-w-7xl mx-auto px-5 sm:px-10 lg:px-20"}>
                    <div className={"flex flex-col gap-4 leading-6 sm:leading-8 text-sm sm:text-base"}>
                        <p>
