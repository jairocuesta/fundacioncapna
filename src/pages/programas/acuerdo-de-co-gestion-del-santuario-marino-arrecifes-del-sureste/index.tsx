        ...
        <Layout title={"Acuerdo de co-gestión del Santuario Marino Arrecifes del Sureste (SAMAR)"}>
            <div className={"flex flex-col gap-16 pb-20 text-center sm:text-left"}>
                ...
                <div className={"flex flex-col gap-4 max-w-7xl mx-auto px-5 sm:px-10 lg:px-20"}>
                    ...
                    <div className={"flex flex-col gap-4 leading-6 sm:leading-8 text-sm sm:text-base"}>
                        <p>
                            Recientemente, en el 2024, el Ministerio de Medio Ambiente y Recursos Naturales aprobó el <a className={'link'} target={'_blank'} href={'https://ambiente.gob.do/planes-de-manejo'}>Plan de Manejo del SAMAR</a>, el cual consiste en un documento técnico y normativo que contiene el conjunto de
                ...
                <div className={"flex flex-col gap-4 max-w-7xl mx-auto px-5 sm:px-10 lg:px-20"}>
                    <div className={"flex flex-col gap-4 leading-6 sm:leading-8 text-sm sm:text-base"}>
                        <p>
                            Al unirte a nosotros en el Programa de Co-Gestión del SAMAR, estás contribuyendo a una adecuada 
                            gestión de los ecosistemas marinos de Cap Cana. Descubre la belleza y la importancia de nuestros 
                            recursos marinos.
                        </p>
                    </div>
                </div>
