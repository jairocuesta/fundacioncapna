                ...
                <div className={"relative flex flex-col items-start w-full max-w-5xl mx-auto py-20 px-5 sm:px-10 gap-20"}>
                    ...
                    <div className={"flex flex-col gap-14 w-full"}>
                        ...
                        <motion.div 
                            ...
                            whileInView={{ bottom: '0px', opacity: 1 }}
                            transition={{ delay: .5 }}  
                            className={`${styles.secondImage} h-[15rem] w-full rounded-xl`}
                        ></motion.div>
                    </div>
                    <motion.div
                        ...
                        transition={{ delay: .3 }}   
                        className={"hidden lg:flex flex-col gap-4 lg:absolute right-0 -top-28 w-1/2 border lg:border-none rounded-xl lg:shadow-xl bg-white p-5 sm:p-10"}
                    >
                        <div className={"text-center text-xl text-[#7D8034] font-semibold"}>Completa los datos</div>
                        <form className={"flex flex-col gap-3 text-left"}>
                            <div>
