...
export default function ConservacionAmbiental() {
    return (
        <Layout title={"Conservación ambiental"} header={{ styles: { background: '#fff', color: 'rgb(125, 128, 52)', image: 'color' } }}>
                ...
                <div className={"flex flex-col gap-14 max-w-7xl mx-auto px-5 sm:px-10 lg:px-20 py-20"}>
                    <div className={"flex flex-col gap-5"}>
                        ...
                        <motion.p
                            ...
                            className={"relative"}
                        >En Cap Cana, la conservación ambiental es más que una prioridad; es un compromiso inquebrantable con la preservación de uno de los paraísos naturales más impresionantes del Caribe. Nos enfocamos en equilibrar el desarrollo sostenible con la protección de la biodiversidad y los ecosistemas marinos y terrestres.</motion.p>
                    </div>
                    <motion.div 
                        initial={{ bottom: '-30px', opacity: 0 }}
                        whileInView={{ bottom: '0px', opacity: 1 }}
                    ...
                    >
                        <Image src={"/home/programs/1.webp"} className={"w-full object-cover"} fill alt={"Conservación terrestre"} />
                    ...
                    <div className={"flex flex-col gap-5"}>
                        ...
                        <ImageGrid images={[
                            { src: '', href: 'programa-reproduccion-de-plantas-nativas-y-endemicas-amenazadas', text: 'Programa reproducción de plantas nativas y endémicas amenazadas' },
                            { src: '', href: 'programa-conservacion-de-orquideas-nativas', text: 'Programa conservación de orquídeas nativas' },
                        ]} />
                    </div>
                    <div className={"flex flex-col gap-5"}>
                        ...
                        <ImageGrid images={[
                            { src: '', href: 'programa-proteccion-de-especies-de-fauna-amenazadas', text: 'Programa protección de especies de fauna amenazadas' },
                            { src: '', href: 'programa-monitoreo-de-fauna-silvestre', text: 'Programa monitoreo de fauna silvestre' },
                            { src: '', href: 'programa-atencion-primaria-fauna-silvestre', text: 'Programa atención primaria a fauna silvestre' },
                            { src: '', href: 'programa-rescate-de-colmenas', text: 'Programa rescate de colmenas' },
                        ]} />
                    </div>
                    <div
                        className={"relative overflow-hidden w-full"}
                        style={{ aspectRatio: '16/7' }}
                    >
                        <Image src={"/home/programs/1.webp"} className={"w-full object-cover"} fill alt={"Conservación marina"} />
                        <div className={"absolute w-full h-full grid place-content-center"}>
                    ...
                    <div className={"flex flex-col gap-5"}>
                        ...
                        <ImageGrid images={[
                            { src: '', href: '', text: 'Acuerdo de co-gestión del Santuario Marino Arrecifes del Sureste (SAMAR)' },
                            { src: '', href: 'programa-rehabilitacion-de-arrecifes-de-coral', text: 'Programa rehabilitación de arrecifes de coral' },
                            ...
                            { src: '', href: 'programa-de-monitoreo-de-anidamiento-de-tortugas-marinas', text: 'Programa de monitoreo de anidamiento de tortugas marinas' },
                            { src: '', href: 'programa-de-registro-de-avistamientos-de-manaties', text: 'Programa de registro de avistamientos de manatíes' },
                        ]} />
                    </div>
                </div>
            </main>
